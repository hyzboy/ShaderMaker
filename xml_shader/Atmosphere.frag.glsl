...
//-- Begin 1 uniforms ----------------------------------------------------------
layout(binding=64,row_major) uniform Atmosphere
{
    vec3 position;
    float intensity;
...
void main()
{
vec3 nrd=vec3(Position.x,-Position.y,Position.z);       //vulkan coord to opengl(shader from opengl sample)
